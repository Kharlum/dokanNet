...
namespace course.core
{
    ...
    public class DokanNet
    {
        ...
        private const uint DOKAN_OPTION_REMOVABLE = 32; // new in course.core 5.2
        ...
        public static int DokanMain(DokanOptions options, DokanOperations operations)
        {
            ...
            dokanOptions.Options |= options.Removable ? DOKAN_OPTION_REMOVABLE : 0; // New in course.core 5.2
